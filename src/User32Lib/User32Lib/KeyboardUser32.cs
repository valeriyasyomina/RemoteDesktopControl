...
{
    /// <summary>
    /// Класс иммитации работы с клавиатурой. Использует скан-коды клавиатуры, а не символы клавиш!
    /// </summary>
    public class KeyboardUser32
    {
        ...
        public const uint KEYEVENTF_KEYUP = 0x0002; // константа, обозначающая "отжатие" клавиши
        ...
        {
            German = 0x407, // Немецкий (стандартный)
            English = 0x409, //Английский (США)
            French = 0x40C, // Французский (стандартный)
            Finnish = 0x40D, // Финский
            Italian = 0x410, // Итальянский
            Polish = 0x415, // Польский
            Russian = 0x419, // Русский
            Ukrainian = 0x422, // Украинский
            Belorusian = 0x423, // Белорусский
            Estonian = 0x0425, // Эстонский
            Latvian = 0x426, // Латвийский
            Lithuanian = 0x427,// Литовский
        }
        ...
        {
            //press the shift key
            keybd_event((byte)WindowsVirtualKey.VK_LSHIFT, 0, 0, 0);
        }
        ...
        public static void ReleaseShift()
        {
            ...
            keybd_event((byte)WindowsVirtualKey.VK_LSHIFT, 0, KEYEVENTF_KEYUP, 0);
        }
        ...
        {
            //press the shift key
            keybd_event((byte)WindowsVirtualKey.VK_LCONTROL, 0, 0, 0);
        }
        ...
        {
            //release the shift key
            keybd_event((byte)WindowsVirtualKey.VK_LCONTROL, 0, KEYEVENTF_KEYUP, 0);
        }
        ...
        {
            //press the shift key
            keybd_event((byte)WindowsVirtualKey.VK_MENU, 0, 0, 0);
        }

        /// <summary>
        /// Отпускание клавиши Alt
        /// </summary>
        public static void ReleaseAlt()
        {
            //release the shift key
            keybd_event((byte)WindowsVirtualKey.VK_MENU, 0x45, KEYEVENTF_KEYUP, 0);
        }

        /// <summary>
        /// Зажатие клавиши с заданным СКАН-кодом
        /// </summary>
        /// <param name="code">скан-код клавиши</param>
        ...
        /// <summary>
        /// Отпускание клавиши с заданным СКАН-кодом
        /// </summary>
        /// <param name="code">скан-код клавиши</param>
        ...
        /// <summary>
        /// Меняет раскладку клавиатуры на заданный язык
        /// </summary>
